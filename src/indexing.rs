...
fn create_payload_windows_exe<'a>(
    ...
    use pahkat_types::fbs::pahkat::WindowsExecutableKind;
    ...
    use pahkat_types::fbs::pahkat::WindowsExecutableFlag;
    ...
    let args = pahkat_types::fbs::pahkat::WindowsExecutableArgs {
        url,
        product_code,
        flags,
        kind,
    ...
    pahkat_types::fbs::pahkat::WindowsExecutable::create(builder, &args).as_union_value()
}
...
fn create_payload_macos_pkg<'a>(
    ...
    use pahkat_types::fbs::pahkat::MacOSPackageFlag;
    ...
    let args = pahkat_types::fbs::pahkat::MacOSPackageArgs {
        url,
        pkg_id,
        flags,
        size: payload.size,
    ...
    pahkat_types::fbs::pahkat::MacOSPackage::create(builder, &args).as_union_value()
}
...
fn create_payload_tarball_pkg<'a>(
    ...
    let url = builder.create_string(payload.url.as_str());
    let args = pahkat_types::fbs::pahkat::TarballPackageArgs {
        url,
        size: payload.size,
        installed_size: payload.installed_size,
    };

    pahkat_types::fbs::pahkat::TarballPackage::create(builder, &args).as_union_value()
}
...
fn create_targets<'d, 'a>(
    ...
    fbs::Vector<'a, fbs::ForwardsUOffset<pahkat_types::fbs::pahkat::Target<&'a [u8]>>>,
> {
    let targets = targets
        .iter()
        .map(|target| {
            ...
            use pahkat_types::fbs::pahkat::fbs_gen::PayloadType;
            ...
            let args = pahkat_types::fbs::pahkat::TargetArgs {
                platform,
                arch,
                dependencies_keys,
                dependencies_values,
            ...
            pahkat_types::fbs::pahkat::Target::create(builder, &args)
        })
        .collect::<Vec<_>>();

    let len = targets.len();
    builder.start_vector::<fbs::ForwardsUOffset<pahkat_types::fbs::pahkat::Target<&'_ [u8]>>>(len);
...
fn create_releases<'d, 'a>(
    ...
    fbs::Vector<'a, fbs::ForwardsUOffset<pahkat_types::fbs::pahkat::Release<&'a [u8]>>>,
> {
    let releases = releases
        ...
        .map(|release| {
            ...
            let args = pahkat_types::fbs::pahkat::ReleaseArgs {
                version_type,
                version,
                channel,
                authors,
            ...
            pahkat_types::fbs::pahkat::Release::create(builder, &args)
        })
        .collect::<Vec<_>>();

    let len = releases.len();
    builder.start_vector::<fbs::ForwardsUOffset<pahkat_types::fbs::pahkat::Release<&'_ [u8]>>>(len);
...
pub(crate) fn build_index<'a>(
    ...
    for _ in id_refs.iter().rev() {
        builder.push(pahkat_types::fbs::pahkat::fbs_gen::PackageType::Descriptor as u8);
    }
    ...
    let packages_values = id_refs
        ...
        .map(|(id_ref, package)| {
            ...
            let args = pahkat_types::fbs::pahkat::DescriptorArgs {
                id: id_ref.clone(),
                name_keys,
                name_values,
                description_keys,
            ...
            pahkat_types::fbs::pahkat::Descriptor::create(builder, &args)
        })
        .collect::<Vec<_>>();

    builder.start_vector::<fbs::ForwardsUOffset<pahkat_types::fbs::pahkat::Descriptor<&'_ [u8]>>>(
        id_refs.len(),
    );
    ...
    let args = pahkat_types::fbs::pahkat::PackagesArgs {
        packages_values_types,
        packages_keys,
        packages_values,
    };

    let root = pahkat_types::fbs::pahkat::Packages::create(builder, &args);
